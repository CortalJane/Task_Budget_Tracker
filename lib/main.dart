...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _loadInitialTaskCount() async {
    ...
    if (storedTasks != null && storedTasks.isNotEmpty) {
      try {
        List<Map<String, dynamic>> tasks = List<Map<String, dynamic>>.from(json.decode(storedTasks));
        setState(() {
...
class _CalendarPageState extends State<CalendarPage> {
  ...
  Future<void> _loadAllTasks() async {
    ...
    if (generalTasks != null && generalTasks.isNotEmpty) {
      try {
        setState(() {
          _allTasks = List<Map<String, dynamic>>.from(json.decode(generalTasks));
          _buildEventsList();
          _isLoading = false;
        });
      } catch (e) {
  ...
  void _addTaskAndUpdateCalendar(Map<String, dynamic> newTask) {
    setState(() {
      ...
      _allTasks.sort((a, b) => DateTime.parse(a['date']).compareTo(DateTime.parse(b['date'])));
      _buildEventsList();
    });
    _saveTasks();
  }
  ...
  void _removeTaskFromCalendar(Map<String, dynamic> taskToRemove) {
    setState(() {
      _allTasks.removeWhere((task) =>
          task['name'] == taskToRemove['name'] && task['date'] == taskToRemove['date']);
      _buildEventsList();
    });
    _saveTasks();
  }

  void _editTaskAndUpdateCalendar(Map<String, dynamic> oldTask, Map<String, dynamic> newTask) {
    setState(() {
                  ...
                  child: Padding(
                    ...
                    child: TableCalendar(
                      ...
                      calendarStyle: CalendarStyle(
                        ...
                        selectedTextStyle: TextStyle(color: Colors.purple.shade700),
                      ...
                      onDaySelected: (selectedDay, focusedDay) {
                        ...
                        _showTaskDetailsDialog(context, _getTasksForDay(selectedDay), selectedDay);
                      },
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: isPriority ? Colors.red.shade50 : Colors.purple.shade50,
                  borderRadius: BorderRadius.circular(10),
                ),
                child: Icon(
                  isPriority ? Icons.priority_high : Icons.event_note,
                  color: isPriority ? Colors.red.shade700 : Colors.purple.shade700,
                  size: 20,
                ),
              ),
  ...
  void _showTaskDetailsDialog(BuildContext context, List<Map<String, dynamic>> tasks, DateTime selectedDate) {
    if (tasks.isEmpty) {
      showModalBottomSheet(
        context: context,
        shape: const RoundedRectangleBorder(
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      padding: const EdgeInsets.all(16),
                      itemCount: tasks.length + 1, // +1 for the add button at the end
                      itemBuilder: (context, index) {
...
class _TaskDetailPageState extends State<TaskDetailPage> with SingleTickerProviderStateMixin {
  ...
  void _updateTaskCount() {
    if (widget.onTaskCountChanged != null) {
      int activeTaskCount = tasks.where((task) => task['completed'] == false).length;
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              if (taskController.text.isNotEmpty && subjectController.text.isNotEmpty) {
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [
              Colors.white,
              task['completed'] == true ? Colors.grey[100]! : secondaryColor.withOpacity(0.3),
            ],
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          ),
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            height: 24,
            decoration: BoxDecoration(
              color: task['completed'] == true ? Colors.green : Colors.transparent,
              shape: BoxShape.circle,
              border: Border.all(
              ...
              Expanded(
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    fontWeight: FontWeight.w600,
                    color: task['completed'] == true ? Colors.grey : Colors.black87,
                    fontSize: 16,
                  ),
                ),
              ),
              ...
              PopupMenuItem<String>(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text(task['reminder'] == true ? 'Remove Reminder' : 'Set Reminder'),
                  ],
                ),
              ),
              PopupMenuItem<String>(
  ...
  Widget _buildPriorityOption(Map<String, dynamic> task, String priority, Color color) {
    return InkWell(
      onTap: () {
        setState(() {
  ...
  void _toggleReminder(Map<String, dynamic> task) {
    setState(() {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(task['reminder'] == true ? 'Reminder set' : 'Reminder removed'),
          backgroundColor: primaryColor,
          behavior: SnackBarBehavior.floating,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
        ),
  ...
  void _editTask(Map<String, dynamic> task) {
    ...
    TextEditingController taskSubjectController = TextEditingController(text: task['subject']);
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                if (taskNameController.text.isNotEmpty && taskSubjectController.text.isNotEmpty) {
                  setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, dynamic>> activeTasks = tasks.where((task) => task['completed'] == false).toList();
    List<Map<String, dynamic>> completedTasks = tasks.where((task) => task['completed'] == true).toList();
...
class _AnimatedTaskItemState extends State<AnimatedTaskItem> with SingleTickerProviderStateMixin {
...
class TaskStatisticsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int highPriorityTasks = tasks.where((task) => 
      (task['priority'] ?? 'medium').toLowerCase() == 'high' && !task['completed']).length;
    int mediumPriorityTasks = tasks.where((task) => 
      (task['priority'] ?? 'medium').toLowerCase() == 'medium' && !task['completed']).length;
    int lowPriorityTasks = tasks.where((task) => 
      (task['priority'] ?? 'medium').toLowerCase() == 'low' && !task['completed']).length;
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildStatItem(totalTasks.toString(), 'Total', Icons.assignment, primaryColor),
              _buildStatItem(activeTasks.toString(), 'Active', Icons.timer, Colors.orange),
              _buildStatItem(completedTasks.toString(), 'Done', Icons.check_circle, Colors.green),
            ],
          ),
          const SizedBox(height: 16),
          Text(
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              _buildPriorityItem('Medium', mediumPriorityTasks, Colors.orange[700]!),
              const SizedBox(width: 8),
          ...
          Expanded(
            child: (widget.task['subtasks'] as List).isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    Map<String, dynamic> subtask = widget.task['subtasks'][index];
...
class _TaskBudgetPageState extends State<TaskBudgetPage> {
  ...
  bool autoUseSavings = false; // Set to false by default to require confirmation
  ...
  double _calculateSavingsUsed() {
    ...
    if (autoUseSavings) {
      double savingsUsed = -regularBudget; // Convert negative budget to positive savings used
      return savingsUsed > _calculateTotalSavings() ? _calculateTotalSavings() : savingsUsed;
    }
  ...
  // Calculate how much savings would be needed for a given expense amount
  double _calculateRequiredSavings(double expenseAmount) {
    double remainingBudget = _calculateRemainingBudget();
    if (remainingBudget >= expenseAmount) {
      return 0; // No savings needed
    }
    return expenseAmount - remainingBudget; // Amount needed from savings
  }

  // Check if there are enough savings for the expense
  bool _hasSufficientSavings(double requiredSavings) {
    return _calculateTotalSavings() >= requiredSavings;
  }
  ...
  // Show QuickAlert for savings confirmation
  Future<bool> _showSavingsConfirmationAlert(double expenseAmount, String expenseName, double requiredSavings) async {
    bool? result = await QuickAlert.show(
      context: context,
      type: QuickAlertType.warning,
      title: 'Insufficient Budget',
      text: 'Your remaining budget is not enough for this expense.\n\n'
          'Expense: $expenseName\n'
          'Amount: ${_formatCurrency(expenseAmount)}\n\n'
          'Remaining Budget: ${_formatCurrency(_calculateRemainingBudget())}\n'
          'Required from Savings: ${_formatCurrency(requiredSavings)}\n'
          'Total Savings Available: ${_formatCurrency(_calculateTotalSavings())}\n\n'
          'Do you want to use your savings to cover this expense?',
      confirmBtnText: 'YES, USE SAVINGS',
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Icon(
                  type == 'income' ? Icons.account_balance : Icons.shopping_cart,
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(Icons.currency_exchange, color: Colors.amber),
                prefixText: '₱ ',
              ),
              keyboardType: TextInputType.number,
            ),
          ...
          ElevatedButton(
            onPressed: () async {
              if (itemNameController.text.isNotEmpty &&
                ...
                if (type == 'income') {
                  // For income, just add it directly
                  setState(() {
                    income.add({
                  ...
                  // For expenses, check if budget is sufficient
                  double expenseAmount = double.parse(itemAmountController.text);
                  int quantity = int.tryParse(itemQuantityController.text) ?? 1;
                  double totalExpenseAmount = expenseAmount * quantity;
                  double requiredSavings = _calculateRequiredSavings(totalExpenseAmount);
                  
                  // If expense exceeds remaining budget, show confirmation
                  if (requiredSavings > 0) {
                    // Check if there are enough savings first
                    if (!_hasSufficientSavings(requiredSavings)) {
                      ...
                      QuickAlert.show(
                        ...
                        text: 'Your remaining budget and savings cannot cover this expense.',
                      );
                    ...
                    // Close the add expense dialog before showing confirmation
                    Navigator.pop(context);
                    
                    // Show savings confirmation dialog
                    bool confirmed = await _showSavingsConfirmationAlert(
                      totalExpenseAmount, 
                    ...
                    if (confirmed) {
                      // User confirmed to use savings
                      setState(() {
                        expenses.add({
                          'name': itemNameController.text,
                          'quantity': quantity,
                          'amount': expenseAmount,
                          'usedSavings': requiredSavings,
                        });
                        // Temporarily enable autoUseSavings for calculations
                        autoUseSavings = true;
                        _saveTaskBudget();
                      });
                      ...
                      QuickAlert.show(
                        ...
                        title: 'Expense Added',
                        text: 'Expense added using ${_formatCurrency(requiredSavings)} from your savings.',
                      );
                    } else {
                      // User declined to use savings
                      QuickAlert.show(
                        context: context,
                        type: QuickAlertType.info,
                        title: 'Transaction Cancelled',
                        text: 'No expense was added to your budget.',
                      );
                    }
                    ...
                    // Regular budget is sufficient, proceed normally
                    setState(() {
                      expenses.add({
                        'name': itemNameController.text,
                        'quantity': quantity,
                    ...
                    QuickAlert.show(
                      ...
                      type: QuickAlertType.success,
                      title: 'Expense Added',
                      text: 'The expense has been added to your budget.',
                    );
                  }
                }
              } else {
            ...
            onPressed: () {
              if (savingsNoteController.text.isNotEmpty &&
                ...
                QuickAlert.show(
                  ...
                  type: QuickAlertType.success,
                  title: 'Savings Added',
                  text: 'Your savings have been added successfully.',
                );
              } else {
                // Show validation error
                QuickAlert.show(
  ...
  // Delete item with QuickAlert confirmation
  void _deleteItem(String type, int index) {
    QuickAlert.show(
      context: context,
      type: QuickAlertType.confirm,
      title: 'Delete ${type.substring(0, 1).toUpperCase() + type.substring(1)}',
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text(
                            _formatCurrency(availableFunds),
                            style: TextStyle(
                              fontSize: 28,
                              fontWeight: FontWeight.bold,
                              color: availableFunds >= 0 ? Colors.green.shade700 : Colors.red,
                            ),
                          ),
                          
                          // Show "Using from savings" label if savings are being used
                          if (savingsUsed > 0)
                            Container(
                              ...
                              child: Text(
                                'Using ${_formatCurrency(savingsUsed)} from savings',
                                style: TextStyle(
                                  fontSize: 12,
                  ...
                  child: expenses.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final quantity = expense['quantity'] as int? ?? 1;
                            final totalAmount = amount * quantity;
                            final usedSavings = expense['usedSavings'] as double?;
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                leading: CircleAvatar(
                                  ...
                                  child: Icon(Icons.shopping_cart, color: Colors.red.shade700, size: 20),
                                ),
                                title: Text(
                                  name,
                                  style: const TextStyle(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    if (usedSavings != null && usedSavings > 0)
                                      Text(
                                        'Used ${_formatCurrency(usedSavings)} from savings',
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: Colors.blue.shade700,
                                          fontStyle: FontStyle.italic,
                                ...
                                trailing: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 4),
                                    GestureDetector(
                                      onTap: () => _deleteItem('expense', index),
                                      child: Container(
                                        padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                                        decoration: BoxDecoration(
